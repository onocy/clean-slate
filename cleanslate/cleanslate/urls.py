...
from doma.views import home, profile, calendar, reminders, finance, edit_chore_deadline, create_chore_deadline
...
urlpatterns = [
    ...
    url(r'^doma/chore/create/$', create_chore_deadline, name = 'create-chore-deadline'),
]
